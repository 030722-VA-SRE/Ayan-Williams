...
//SELLER AND BASIC USER METHODS FOR FINDING USERS INFO
	...
	@GetMapping
	public ResponseEntity<List<UserDTO>> getUsers(@RequestHeader(value = "Authorization", required = true) String token){
...
//	
//	@PostMapping
//	public ResponseEntity<String> createUser(@PathVariable("id") int id, @RequestHeader("Authorization") String token, @RequestBody User user) {
//		if (token == null) {
